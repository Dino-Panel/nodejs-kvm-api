...
class QemuNetworkInterface {
  ...
  get mac() {
    ...
    get inboundBandwith() {
        if(this.#xml.bandwidth == undefined){
            this.#xml.bandwidth = [
                {
                  inbound: [
                    { $: { average: "0", peak: "0", burst: "0" } },
        ...
        return this.#xml.bandwidth[0].inbound[0].$.average;
    }

    set inboundBandwith(value) {
        this.#xml.bandwidth[0].inbound[0].$.average = value;
        this.#xml.bandwidth[0].inbound[0].$.peak = value * 1.1;
        this.#xml.bandwidth[0].inbound[0].$.burst = value * 1.25;
    ...
    set outboundBandwith(value) {
        ...
        this.#xml.bandwidth[0].outbound[0].$.peak = value * 1.1;
        this.#xml.bandwidth[0].outbound[0].$.burst = value * 1.25;
